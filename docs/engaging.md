...
5. To access the Engaging cluster for the first time, you will need to log in via the Engaging Open OnDemand Portal.  For instructions, see [here](https://orcd-docs.mit.edu/accessing-orcd/ondemand-login/).
...
The Engaging Cluster has head/login nodes to access the cluster and submit jobs to the compute nodes which run your resource intensive scripts.  Job orchestration is performed with the Slurm Workload Manager.  The [ORCD Docs](https://orcd-docs.mit.edu/) provides details on these operations, including:

1. [Logging into the cluster with SSH](https://orcd-docs.mit.edu/accessing-orcd/ssh-login/)
1. [Overview and common commands to interact with the Slurm Job Scheduler](https://orcd-docs.mit.edu/running-jobs/overview/)
1. [Run interactive jobs and jobs in parallel](https://orcd-docs.mit.edu/running-jobs/overview/#running-jobs)
1. [Access installed software](https://orcd-docs.mit.edu/software/overview/)
1. [Analyzing job resource usage](https://orcd-docs.mit.edu/running-jobs/application-analysis/)
